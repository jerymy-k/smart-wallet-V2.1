  ...
  <div class="relative flex min-h-screen">
    <div class="flex w-full lg:w-[44%] items-center justify-center px-4 py-12 sm:px-6 lg:px-16">
      <div class="w-full max-w-md">
        <div class="flex items-center gap-3">
          <div
            class="h-10 w-10 rounded-xl bg-gradient-to-br from-primary to-indigoGlow shadow-glow flex items-center justify-center">
        ...
        <?php if ($error): ?>
          <div
            class="mt-6 rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-3 text-sm text-red-100 flex gap-3 items-start">
        ...
        <div class="mt-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-soft p-6">
          <form method="POST" autocomplete="off" class="space-y-5">
            <div>
              ...
              <div class="relative">
                <span
                  class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-white/50">person</span>
                <input name="email" type="email" required value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>"
                  placeholder="name@example.com" class="w-full rounded-xl bg-white/5 border border-white/10 pl-11 pr-4 py-3 text-white placeholder:text-white/40
            ...
            <div>
              <div class="flex items-center justify-between mb-2">
                ...
                <a href="#" class="text-sm font-semibold text-primary hover:text-primary/80 transition">Mot de passe
                  oublié ?</a>
              </div>
              <div class="relative">
                <span
                  class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-white/50">lock</span>
                <input id="password" name="password" type="password" required placeholder="••••••••" class="w-full rounded-xl bg-white/5 border border-white/10 pl-11 pr-11 py-3 text-white placeholder:text-white/40
                         focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/40 transition" />
            ...
            <button type="submit" class="w-full rounded-xl py-3 font-bold tracking-tight text-white
    ...
    <div class="hidden lg:flex flex-1 relative">
      ...
      <div class="relative w-full flex items-end p-16">
        <div class="max-w-xl">
          <div
            class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 border border-white/10 backdrop-blur">
